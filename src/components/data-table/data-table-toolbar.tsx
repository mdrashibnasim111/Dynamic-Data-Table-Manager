            ...
            {isEditing ? (
              <>
                <Button
                  ...
                  size="sm"
                  onClick={handleSave}
                  className="btn-clay flex flex-1 items-center justify-center gap-1.5 text-xs font-medium py-2.5 px-3 rounded-lg bg-green-500/20 hover:bg-green-500/30 border-green-500/50"
                >
                ...
                <Button
                  ...
                  className="btn-clay flex flex-1 items-center justify-center gap-1.5 text-xs font-medium py-2.5 px-3 rounded-lg bg-red-500/20 hover:bg-red-500/30 border-red-500/50"
                >
